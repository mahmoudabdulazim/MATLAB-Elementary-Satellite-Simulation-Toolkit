...
classdef Satellite < handle
    ...
    methods
        ...
        function [Satellite] = COERV(Satellite,AoA,i,AoP,nu0,e,a,t0,Name)
            Satellite.Name    = Name;
            Satellite.Orbit.e = e;  Satellite.Orbit.AoA = AoA;
            Satellite.Orbit.a = a;  Satellite.Orbit.AoP = AoP;
            Satellite.Orbit.i = i;  
            Satellite.Orbit.Energy   = -mu/(2*Satellite.Orbit.a);
            Satellite.InitialConditions.nu0 = nu0;
            Satellite.InitialConditions.t0  = t0;
            Satellite.Categorize();
            Satellite.Characterize();
            Satellite.InitialConditions.E0   = Calculate_E0(Satellite.Orbit.e,Satellite.InitialConditions.nu0);
            Satellite.InitialConditions.M0   = Calculate_M0(Satellite.InitialConditions.E0,Satellite.Orbit.e);
        ...
        function [Satellite] = Categorize(Satellite)
            if (Satellite.Orbit.e ~= 1)
                Satellite.Orbit.h = sqrt(0.5 * mu^2 * (Satellite.Orbit.e^2 - 1)/Satellite.Orbit.Energy);
                Satellite.Orbit.a        = -mu/(2*Satellite.Orbit.Energy);
                Satellite.Orbit.p        = Satellite.Orbit.a*(1-Satellite.Orbit.e^2);
                if Satellite.Orbit.e > 1
                ...
                if isempty(Satellite.Orbit.a)
                    Satellite.Orbit.a = Inf;
                end
                Satellite.Orbit.b        = Inf;
                Satellite.Orbit.p        = 2*Satellite.Orbit.a;
                Satellite.Orbit.h        = sqrt(Satellite.Orbit.p * mu);
